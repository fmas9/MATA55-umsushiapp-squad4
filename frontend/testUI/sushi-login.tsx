    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">UmSushiApp</h1>
          <p className="text-gray-600">Sabores autênticos do Japão</p>
        </div>
        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-center text-gray-600">
              Entre na sua conta para fazer seus pedidos
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter className="flex flex-col space-y-4 pt-6">
            <div className="text-center text-sm text-gray-600">
              Não tem uma conta?{" "}
              <button className="text-red-600 hover:text-red-700 font-medium">Cadastre-se aqui</button>
            </div>

            <div className="text-center">
              <p className="text-xs text-gray-500">
                Ao continuar, você concorda com nossos{" "}
                <button className="text-red-600 hover:underline">Termos de Uso</button> e{" "}
                <button className="text-red-600 hover:underline">Política de Privacidade</button>
              </p>
            </div>
          </CardFooter>
        </Card>
        ...
        <div className="text-center mt-8 text-sm text-gray-500">
          <p>© 2024 UmSushiApp. Todos os direitos reservados.</p>
        </div>
      </div>
    </div>
  )
